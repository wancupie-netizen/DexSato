...
/* TW-DEX-05 — compact quote, consent and in-place wallet flow. */
.trade-v05{gap:10px}.trade-v05[data-quote-ready="true"] [data-get-quote]{height:34px;border:1px solid var(--line)!important;background:transparent!important;color:var(--muted)!important;font-size:10px}.trade-quote-compact-v05{display:grid;grid-template-columns:1.35fr .8fr .9fr;gap:1px;overflow:hidden;border:1px solid var(--line);border-radius:7px;background:var(--line)}.trade-quote-compact-v05[hidden]{display:none}.trade-quote-metric-v05{min-width:0;padding:9px 8px;background:#0a1119}.trade-quote-metric-v05 span{display:block;margin-bottom:4px;color:var(--muted);font-size:8px;text-transform:uppercase;letter-spacing:.04em}.trade-quote-metric-v05 b{display:block;color:var(--text);font:650 9px/1.35 var(--mono);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.trade-quote-details-v05{border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.trade-quote-details-v05[hidden]{display:none}.trade-quote-details-v05 summary{padding:9px 2px;color:var(--muted);font:650 9px var(--ui);cursor:pointer;list-style:none}.trade-quote-details-v05 summary::-webkit-details-marker{display:none}.trade-quote-details-v05 summary:after{content:"+";float:right;color:var(--trade-accent)}.trade-quote-details-v05[open] summary:after{content:"−"}.trade-quote-details-v05 .quote-result-v27.visible{max-height:250px;overflow:auto;border-radius:6px}.trade-quote-details-v05 .trade-route-v04{margin-top:8px}.trade-consent-v05{display:flex;gap:7px;align-items:flex-start;margin:0;color:var(--muted);font-size:9px;line-height:1.4}.trade-consent-v05 i{color:var(--trade-accent);font-style:normal}.trade-status-v05{display:grid;align-items:center;min-height:38px}.trade-status-v05 .quote-result{margin:0}.trade-status-v05 .quote-result.visible{padding:9px 10px;border-radius:6px;background:rgba(76,244,214,.045);font-size:10px}.trade-status-v05 .quote-result.quote-error{background:rgba(255,95,120,.06)}.trade-status-v05 .quote-result.swap-success{background:rgba(34,210,127,.07)}.trade-v05 .swap-confirmation-v27{display:none!important}.trade-v05 .swap-warning-v27{padding:9px 10px;font-size:9px}.trade-v05 .wallet-safety-v27{font-size:9px}
...
<section class="card jupiter jupiter-v27 trade-v04 trade-v05" data-jupiter-sandbox data-token-address="__TOKEN__" data-token-symbol="__SYMBOL__" data-side="buy" data-quote-ready="false">
  ...
  <div class="trade-quote-compact-v05" data-quote-compact hidden aria-live="polite"><div class="trade-quote-metric-v05"><span>Minimum receive</span><b data-compact-minimum>—</b></div><div class="trade-quote-metric-v05"><span>Price impact</span><b data-compact-impact>—</b></div><div class="trade-quote-metric-v05"><span>DexSato fee</span><b data-compact-fee>—</b></div></div>
  <details class="trade-quote-details-v05" data-quote-details hidden><summary>Quote &amp; fee details</summary><div class="quote-result quote-result-v27" data-quote-result aria-live="polite"></div><div class="trade-route-v04"><span>Route</span><b data-route-summary>SOL &rarr; Jupiter &rarr; __SYMBOL__</b></div></details>
  ...
  <label class="trade-consent-v05"><input class="sr-only" type="checkbox" data-swap-risk-ack tabindex="-1"><i aria-hidden="true">✓</i><span>By selecting Buy or Sell, you accept the displayed quote, price impact and disclosed fee.</span></label>
  <section class="swap-confirmation-v27" data-confirmation-summary hidden aria-live="polite"></section>
  <button class="sandbox-button primary" type="button" data-execute-swap disabled>Buy __SYMBOL__</button>
  <div class="trade-status-v05"><div class="quote-result" data-swap-result aria-live="polite"></div></div>
...
</main></div></div><script src="/static/js/dexsato_solana_discovery_swap.js?v=tw-dex-05" defer></script><script>
(function(){
